//
//  TherapyRingView.swift
//  CardinalKit_Example
//
//  Created by Vishnu Ravi on 3/2/22.
...
struct TherapyRingView: View {
            ...
            ZStack {
                ...
                if self.getShowShadow(frame: geometry.size) {
                    Circle()
                        ...
                        .shadow(color: TherapyRingView.ShadowColor,
                                radius: TherapyRingView.ShadowRadius,
    ...
    private func getEndCircleShadowOffset() -> (CGFloat, CGFloat) {
        ...
        let xOffset = relativeXOffset.toCGFloat() * TherapyRingView.ShadowOffsetMultiplier
        let yOffset = relativeYOffset.toCGFloat() * TherapyRingView.ShadowOffsetMultiplier
